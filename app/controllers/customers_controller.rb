...
private
def customer_params
params.require(:customer_area).permit(:postal, :region_id, :city, :city_num, :building, :tel_num, :price).merge(user_id: current_user.id, token: params[:token], item_id: params[:item_id], customer_id: current_user.id)
